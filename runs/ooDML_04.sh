...
python main.py 'model.params.config.Architecture.params.embed_dim=512' 'lightning.logger.params.group=ooDML_non_vq_02' "lightning.logger.params.wandb_key=${WANDB_KEY}" 'lightning.trainer.max_epochs=100' \
               ...
               --savename baseline_frozen_normalize_512_multisimilarity_sop_s1 --exp_path ${EXP_PATH} --gpus ${GPU_TRAINING} --base configs/multisimloss.yaml
...
python main.py 'model.params.config.Architecture.params.embed_dim=512' 'lightning.logger.params.group=ooDML_non_vq_02' "lightning.logger.params.wandb_key=${WANDB_KEY}" 'lightning.trainer.max_epochs=100' \
               ...
               'model.params.config.Architecture.params.VQ=False' \
               --savename baseline_frozen_normalize_512_multisimilarity_sop_s2 --exp_path ${EXP_PATH} --gpus ${GPU_TRAINING} --base configs/multisimloss.yaml
...
python main.py 'model.params.config.Architecture.params.embed_dim=512' 'lightning.logger.params.group=ooDML_non_vq_02' "lightning.logger.params.wandb_key=${WANDB_KEY}" 'lightning.trainer.max_epochs=100' \
               ...
               'model.params.config.Architecture.params.VQ=False' \
               --savename baseline_frozen_normalize_512_multisimilarity_sop_s3 --exp_path ${EXP_PATH} --gpus ${GPU_TRAINING} --base configs/multisimloss.yaml
...
python main.py 'model.params.config.Architecture.params.embed_dim=512' 'lightning.logger.params.group=ooDML_non_vq_02' "lightning.logger.params.wandb_key=${WANDB_KEY}" 'lightning.trainer.max_epochs=100' \
               ...
               'model.params.config.Architecture.params.VQ=False' \
               --savename baseline_frozen_normalize_512_multisimilarity_sop_s4 --exp_path ${EXP_PATH} --gpus ${GPU_TRAINING} --base configs/multisimloss.yaml
...
python main.py 'model.params.config.Architecture.params.embed_dim=512' 'lightning.logger.params.group=ooDML_non_vq_02' "lightning.logger.params.wandb_key=${WANDB_KEY}" 'lightning.trainer.max_epochs=100' \
               ...
               'model.params.config.Architecture.params.VQ=False' \
               --savename baseline_frozen_normalize_512_multisimilarity_sop_s5 --exp_path ${EXP_PATH} --gpus ${GPU_TRAINING} --base configs/multisimloss.yaml
...
python main.py 'model.params.config.Architecture.params.embed_dim=512' 'lightning.logger.params.group=ooDML_non_vq_02' "lightning.logger.params.wandb_key=${WANDB_KEY}" 'lightning.trainer.max_epochs=100' \
               ...
               'model.params.config.Architecture.params.VQ=False' \
               --savename baseline_frozen_normalize_512_multisimilarity_sop_s6 --exp_path ${EXP_PATH} --gpus ${GPU_TRAINING} --base configs/multisimloss.yaml
...
python main.py 'model.params.config.Architecture.params.embed_dim=512' 'lightning.logger.params.group=ooDML_non_vq_02' "lightning.logger.params.wandb_key=${WANDB_KEY}" 'lightning.trainer.max_epochs=100' \
               ...
               'model.params.config.Architecture.params.VQ=False' \
               --savename baseline_frozen_normalize_512_multisimilarity_sop_s7 --exp_path ${EXP_PATH} --gpus ${GPU_TRAINING} --base configs/multisimloss.yaml
...
python main.py 'model.params.config.Architecture.params.embed_dim=512' 'lightning.logger.params.group=ooDML_non_vq_02' "lightning.logger.params.wandb_key=${WANDB_KEY}" 'lightning.trainer.max_epochs=100' \
               ...
               'model.params.config.Architecture.params.VQ=False' \
               --savename baseline_frozen_normalize_512_multisimilarity_sop_s8 --exp_path ${EXP_PATH} --gpus ${GPU_TRAINING} --base configs/multisimloss.yaml