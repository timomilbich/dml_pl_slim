...
class DATA(Dataset):
    ...
    def __init__(
        ...
        self.root = "/export/home/tmilbich/Datasets/cars196/" if root is None else root
        self.n_classes = 98
        self.path_ooDML_splits = "/export/home/tmilbich/PycharmProjects/dml_pl/data/ooDML_splits/cars196_splits.pkl"
